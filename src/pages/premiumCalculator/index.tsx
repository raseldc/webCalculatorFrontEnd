  ...
  return (
    <CalculatorLayout>
      ...
      <div className="flex w-full">
          <CalculatorButton onClick={handleClick} value="MC" className="bg-[#f7ccb2] hover:bg-opacity-80 text-black text-xl font-light mx-[1px] my-[1px]" />
          <CalculatorButton onClick={handleClick} value="MR" className="bg-[#f7ccb2] hover:bg-opacity-80 text-black text-xl font-light mx-[1px] my-[1px]" />
          <CalculatorButton onClick={handleClick} value="M+" className="bg-[#f7ccb2] hover:bg-opacity-80 text-black text-xl font-light mx-[1px] my-[1px]" />
          <CalculatorButton onClick={handleClick} value="M-" className="bg-[#f7ccb2] hover:bg-opacity-80 text-black text-xl font-light mx-[1px] my-[1px]" />
          <CalculatorButton onClick={handleClick} value="MS" className="bg-[#f7ccb2] hover:bg-opacity-80 text-black text-xl font-light mx-[1px] my-[1px]" />
          <CalculatorButton onClick={handleClick} value="Mv" className="bg-[#f7ccb2] hover:bg-opacity-80 text-black text-xl font-light mx-[1px] my-[1px]" />
        </div>
        <div className="flex w-full">
